...
export const initialState = {
  ...
  nodes: [
    ...
    {id: 1, node: 'test/test2.so', name: 'test2', check: 'checkbox', selected: false }
  ],
  links: [
...
const store = createStore(combineReducers({nodes, counts, nodeInfo, graphFiles, loading, links, graphData, findNode}), initialState);
